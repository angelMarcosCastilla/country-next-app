...
export default function LoadingCountry() {
  return (
    <div className="container py-14 animate-pulse">
      <div className="shadow-md h-[37px] w-[100px] dark:bg-gray-700"></div>
      <article className="py-14 mt-5 flex gap-x-20 flex-wrap">
        <section>
          <div className="w-[500px] h-[300px] bg-gray-300 dark:bg-gray-500 grid place-content-center">
            <svg
        ...
        <section className="">
          <p className="h-10 w-32 bg-gray-300 dark:bg-gray-500 mb-4"></p>
          <div className="flex flex-row gap-10">
            <div className="flex flex-col gap-3">
              <p className="h-[20px] w-[200px]  bg-gray-300 dark:bg-gray-500"></p>
              <p className="h-[20px] w-[200px] bg-gray-300 dark:bg-gray-500"></p>
              <p className="h-[20px] w-[200px] bg-gray-300 dark:bg-gray-500"></p>
              <p className="h-[20px] w-[200px] bg-gray-300 dark:bg-gray-500"></p>
            </div>
